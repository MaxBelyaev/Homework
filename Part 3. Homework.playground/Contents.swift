...
//Доработать алгоритм из предыдущего задания
...
func literify(_ str: String) -> String {
    ...
    let wordsArr = str.components(separatedBy:.whitespaces)
...
//        }
    ...
    return wordsArr.map{Set($0).isSubset(of:Set(dict.keys)) ? descriptNumber($0) : $0} .reduce("", {$0 + " " + $1})
    
}

literify("Я охренел от полученных знаний 1218 раз")
